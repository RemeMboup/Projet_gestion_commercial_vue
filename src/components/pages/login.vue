                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 mt-3 ">
                                            <div class="form-group">
                                                    ...
                                                    <input v-model="login.email" name="email" id="email"  required autofocus placeholder="Email" class="form-control" />
...
export default {
    ...
    computed: {
        login () {
            return this.$store.state.login3
        }
    },
    methods: {
       auth () {
       ...
       authentification () {
            this.$store.dispatch('authentification')
        }
    }
}
</script>
