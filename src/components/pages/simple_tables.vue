<template>
    <div>
        ...
        <b-modal id="modaledit" title="Edit details" :ok-only="true" ref="myModalRefTwo" >
            ...
            <div slot="modal-footer" class="w-100">
                <b-btn size="sm" class="float-right" variant="success"  @click="hideModal">
        ...
        <b-modal ref="myModalRef" id="modaldelete" title="Delete Details" >
            <div class="modal-body">
                <div class="alert alert-info">
                    <span class="glyphicon glyphicon-info-sign"></span>&nbsp; Are you sure you want to
                    delete this record ?
            ...
            <div slot="modal-footer" class="float-right">
                <button type="button" class="btn btn-danger" data-dismiss="modal" @click="hideModal">
                    <span class="ti-check"></span> Yes
                </button>
                <button type="button" class="btn btn-success" data-dismiss="modal" @click="hideModal">
