    ...
    <div>
        ...
        <div class="row">
            <div class="col-md-6 col-sm-6">
                <div class="card">
                    <div class="card-header">
                        <h4 class="iconset_name card-title">Themify Icons</h4>
            ...
            <div class="col-md-6 col-sm-6">
                <div class="card">
                    <div class="card-header">
                        <h4 class="iconset_name card-title">Font Awesome Icons</h4>
                        <span class="float-right">
                                    <i class="fa fa-fw ti-angle-up clickable"></i>
                                    <i class="fa fa-fw ti-close removecard"></i>
                                </span>
            ...
            <div class="col-md-6 col-sm-6 m-t-10">
                <div class="card">
                    <div class="card-header">
                        <h4 class="iconset_name card-title">Simple Line Icons</h4>
                        <span class="float-right">
                                    <i class="fa fa-fw ti-angle-up clickable"></i>
                                    <i class="fa fa-fw ti-close removecard"></i>
                                </span>
